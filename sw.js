const CACHE_NAME = 'dankconnect-v32';
const ASSETS = [
  './',
  './index.html?v=32',
  './index.html',
  ...
  if (req.mode === 'navigate') {
    e.respondWith(
      fetch(req).then(res => {
        ...
        return res;
      }).catch(() => caches.match('./index.html?v=32') || caches.match('./index.html') || caches.match(req))
    );
    return;
  }
  e.respondWith(
